...
const targetCampaign = targetIo.children.dspCampaigns[0];
const targetLineItem = targetCampaign.children.lineItem000;
...
testData001.name = 'SC1 ' + testData001.name + timeStamp + ' (clone)';
...
describe('<SMOKE> {{MAVERICK}} /line-item {clone} @MANAGER >>> ' +
    ...
    it('should add postal codes', function(done) {
        expect(lineItemPage.getLinkAdvancedTargeting()).to.exist;
    ...
    it('should add Live Audience Target' , function(done) {
